...
async function testGA4Connection() {
  try {
    ...
    console.log('📈 Total users (last 7 days):', testResponse[0].rows?.[0]?.metricValues?.[0]?.value || 'No data');
    ...
    if (error.message.includes('PERMISSION_DENIED')) {
      ...
      console.log('3. Add: kumarsemantic@my-project-74001686249.iam.gserviceaccount.com');
