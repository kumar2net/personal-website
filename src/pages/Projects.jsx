...
const projects = [
  ...
  },
  {
    ...
    description: 'The MedicineChk App leverages AI to check interactions between drugs. That used to be my biggest mental block - all these medicines I am being prescribed, are they tested together in a cat or rat, or am I the guinea pig! This app helps identify potential drug interactions using nC2 combinations to ensure safety.',
    tech: ['React', 'Node.js', 'Express', 'Machine Learning', 'Drug Interaction API'],
    ...
    impact: 'Providing peace of mind by checking drug interactions before taking multiple medications, ensuring patient safety through comprehensive interaction analysis.'
  }
];
