    ...
    >
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Vim Keyboard Shortcuts</h1>
            <p className="text-gray-600">Master essential Vim commands for efficient text editing</p>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-3 text-center">Vim Modes</h3>
