...
const NammuSoilAnalysisResearch = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-bold mb-6">revolutionizing soil analysis: laser vs traditional methods</h1>
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">Agriculture</span>
        <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">Research</span>
        <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm font-medium">Soil Science</span>
        <span className="px-3 py-1 bg-orange-100 text-orange-800 rounded-full text-sm font-medium">Technology</span>
        <span className="px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm font-medium">Environmental</span>
        <span className="px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm font-medium">Construction</span>
        <span className="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm font-medium">Scientific Method</span>
      </div>

      <AuthorBio 
        author="Namritha . R"
        bio="Second year Masters student"
      />
      ...
      <div className="space-y-8">
        ...
        <div ref={articleRef} className="prose prose-lg max-w-none">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            <img src="https://img.shields.io/badge/Sieve_Hydrometer-Traditional_Method-8B5CF6?style=for-the-badge&logo=laboratory&logoColor=white" alt="Sieve Hydrometer Method" />
            <img src="https://img.shields.io/badge/Laser_Diffraction-Advanced_Tech-EF4444?style=for-the-badge&logo=laser&logoColor=white" alt="Laser Diffraction Method" />
            <img src="https://img.shields.io/badge/Florida-Research_Sites-10B981?style=for-the-badge&logo=location&logoColor=white" alt="Florida Research" />
            <img src="https://img.shields.io/badge/75_Samples-Comprehensive_Study-F59E0B?style=for-the-badge&logo=data&logoColor=white" alt="75 Samples Study" />
          </div>
          ...
          <div className="mb-10">
            <img 
              ...
              onError={(e) => {
                e.target.src = 'https://via.placeholder.com/1200x400/059669/ffffff?text=Soil+Analysis+Research';
              }}
            />
            <p className="text-sm text-gray-500 text-center mt-2">
              Photo by <a href="https://unsplash.com/@vlisidis" className="underline hover:text-gray-700">Vlad Tchompalov</a> on <a href="https://unsplash.com" className="underline hover:text-gray-700">Unsplash</a>
            </p>
          </div>
          ...
          <section className="mb-8">
            ...
            <p className="text-base sm:text-lg leading-relaxed mb-6">
              With LDM, a laser is shone through soil particles dispersed in water. Bigger particles scatter this light differently than the smaller particles. A computer is connected to the laser and sorts these particles into different size classes. This method is faster and better at finding these miniscule particles.
            </p>



            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-8">
              <h3 className="text-lg font-semibold mb-3 text-blue-800">🔬 Our Two Main Questions</h3>
              <div className="text-blue-700">
                <p className="mb-2">1. Do these methods produce different soil classifications?</p>
                <p>2. Is the laser method better at finding those smaller particles?</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 my-8">
              <h3 className="text-lg font-semibold mb-2 text-amber-800">⚡ Speed Comparison</h3>
              <p className="text-amber-700">
                <strong>LDM:</strong> 13 hours per soil sample<br/>
                <strong>SHM:</strong> 74 hours per soil sample<br/>
          ...
          <section className="mb-12">
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-6 my-8">
              <h3 className="text-lg font-semibold mb-2 text-indigo-800">🎯 Key Takeaway</h3>
              <p className="text-indigo-700">
                Consistency of method is important because they might not always match - so stick with one.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-base sm:text-lg leading-relaxed mb-8 text-gray-700">
              The following charts and graphs illustrate our findings from the comparative analysis of both methods across all 75 soil samples.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white p-4 rounded-lg shadow-lg border">
                ...
                <p className="text-sm text-gray-600 mt-3 text-center italic">
                  Method comparison showing classification differences between SHM and LDM
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-4 rounded-lg shadow-lg border">
                ...
                />
                <p className="text-sm text-gray-600 mt-3 text-center italic">
                  Florida sample sites showing geographical diversity in soil types
                </p>
              </div>
            </div>
          </section>
