  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold mb-4">Atheism: A Wonderful World Without Religion</h1>
        <p className="text-gray-600 text-lg mb-2">By Tom Miles</p>
        <p className="text-gray-600 text-sm mb-6">A philosophical exploration of atheism and its implications</p>
        <div className="flex flex-wrap gap-2 mb-6">
          <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">Philosophy</span>
          <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Atheism</span>
          <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">Worldview</span>
          <span className="px-3 py-1 bg-orange-100 text-orange-800 rounded-full text-sm">Religion</span>
        </div>
      </div>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">The Nature of Religious Belief</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Morality and Evolution</h2>
          <p className="mb-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
          ...
          <p className="text-blue-700 text-sm mb-4">
            Tom Miles is the author of "Atheism: A Wonderful World Without Religion," which explores the philosophical foundations and practical implications of atheism in modern society.
          </p>
        </div>
      </div>
    </div>
