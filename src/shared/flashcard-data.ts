...
export const flashcardSets: FlashcardSet[] = [
  {
    ...
    description: 'Master the 12 most essential macOS keyboard shortcuts for productivity',
    cardCount: 12,
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    description: 'Speed up your browsing with essential Safari and Chrome shortcuts',
    cardCount: 15,
    difficulty: 'Beginner',
  ...
  {
    id: 'vocab-additions',
    title: 'Addition to my Vocabulary',
    description: 'New words I have recently learned and their meanings',
    cardCount: 4,
    difficulty: 'Beginner',
    estimatedTime: '3 min',
    category: 'Vocabulary',
    ...
    icon: 'BookText',
    cards: [
      { front: "Cobot", back: "A collaborative robot designed to work alongside humans in a shared workspace, often in manufacturing or service industries." },
      { front: "Hyborg", back: "A hybrid cyborg; a being that combines organic and biomechatronic body parts, often used to describe humans enhanced with both biological and robotic elements." },
      { front: "Zidd (Hinglish)", back: "A Hindi/Urdu word meaning stubbornness or persistence. In Hinglish, it often refers to a strong will or determination to achieve something, even against odds." },
      { front: "Autophagy", back: "A natural process in which the body breaks down and recycles its own cells and components, important for cellular health and longevity." }
    ]
  }
]; 