      ...
      {error && (
        <div className="mt-3 p-3 bg-red-100 border border-red-200 rounded-md">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-red-800 font-medium">Failed to save subscription:</p>
              <p className="text-sm text-red-700 mt-1">{error}</p>
              <p className="text-xs text-red-600 mt-2">
                This might be a temporary issue. Please try again or check your internet connection.
              </p>
            </div>
          </div>
        </div>
