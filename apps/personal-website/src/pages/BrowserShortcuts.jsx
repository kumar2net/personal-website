        ...
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Master Safari & Chrome shortcuts for faster browsing
            </p>
          </div>
        </div>
      ...
      {currentIndex === reversedFlashcards.length - 1 && flipped && (
        ...
        >
          ...
          <p className="text-green-700 mb-4">
            You've mastered all {reversedFlashcards.length} browser shortcuts!
            Your web browsing is about to get much faster! 🚀
          </p>
