...
function renderDiagnosisMarkdown(params: {
  ...
  return [
    ...
    "",
    "## Metric Notes",
    "- CTR here reflects thumbnail-impression surfaces, not the Shorts swipe/feed experience.",
    "- Use average view %, average view duration, and first-3s retention together when judging in-feed opening hold and pacing.",
    "",
    "## Primary Fix",
